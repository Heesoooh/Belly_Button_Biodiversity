...
function demoInfo(sample)
{
    ...
    d3.json("samples.json").then((data) => {
        ...
        // use object.enteries to get the value key pairs 
...
// function taht builds the bubble chart
...
function initialize()
{
    ...
    // access the dropdwon selector from the index.html file
    ...
    d3.json("samples.json").then((data) => {
        ...
        // when initailized, pass in the infromation for the first sample
        ...
        // call the fucntion to build the bubble chart
